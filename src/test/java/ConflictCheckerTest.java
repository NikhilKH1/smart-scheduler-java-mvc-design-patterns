...
public class ConflictCheckerTest {
  ...
  public void testEventCompletelyInsideAnother() {
    ...
    SingleEvent outerEvent = new SingleEvent("Outer Event", start1, end1, "", "", true, false, null);
    SingleEvent innerEvent = new SingleEvent("Inner Event", start2, end2, "", "", true, false, null);

    assertTrue("Event inside another should conflict", ConflictChecker.hasConflict(outerEvent, innerEvent));
  }
  ...
  public void testEventTouchingStartNoConflict() {
    ...
    assertFalse("Events that just touch should NOT conflict", ConflictChecker.hasConflict(event1, event2));
  }
  ...
  public void testEventTouchingEndNoConflict() {
    ...
    assertFalse("Events that just touch at the end should NOT conflict", ConflictChecker.hasConflict(event1, event2));
  }
  ...
  public void testIdenticalEventsConflict() {
    ...
    SingleEvent event1 = new SingleEvent("Event 1", start, end, "", "", true, false, null);
    SingleEvent event2 = new SingleEvent("Event 1", start, end, "", "", true, false, null);

    assertTrue("Identical events should conflict", ConflictChecker.hasConflict(event1, event2));
  }
  ...
  public void testLongOverlappingEventsConflict() {
    ...
    assertTrue("Long overlapping events should conflict", ConflictChecker.hasConflict(event1, event2));
  }
  ...
  public void testMultipleConflictingEvents() {
    ...
    SingleEvent event1 = new SingleEvent("Event 1", start1, end1, "", "", true, false, null);
    SingleEvent event2 = new SingleEvent("Event 2", start2, end2, "", "", true, false, null);
    SingleEvent event3 = new SingleEvent("Event 3", start3, end3, "", "", true, false, null);

    assertTrue("Events 1 and 2 should conflict", ConflictChecker.hasConflict(event1, event2));
    assertTrue("Events 2 and 3 should conflict", ConflictChecker.hasConflict(event2, event3));
    assertTrue("Events 1 and 3 should conflict", ConflictChecker.hasConflict(event1, event3));
  }
  ...
  public void testMidnightBoundary() {
    ...
    SingleEvent event1 = new SingleEvent("Late Night Event", start1, end1, "", "", true, false, null);
    SingleEvent event2 = new SingleEvent("Early Morning Event", start2, end2, "", "", true, false, null);

    assertTrue("Events crossing midnight should conflict", ConflictChecker.hasConflict(event1, event2));
  }
  ...
  public void testMultiDayEventOverlap() {
    ...
    SingleEvent event1 = new SingleEvent("Conference", start1, end1, "", "", true, false, null);
    SingleEvent event2 = new SingleEvent("Meeting", start2, end2, "", "", true, false, null);

    assertTrue("Multi-day events should detect conflicts correctly", ConflictChecker.hasConflict(event1, event2));
  }
