...
public class SingleEventTest {
  ...
  public void testCreateSingleEvent() {
    ...
    SingleEvent event = new SingleEvent("Meeting", start, end, "Team discussion", "Room 101", true, false, null);
  ...
  public void testAllDayEvent() {
    ...
    SingleEvent event = new SingleEvent("Holiday", start, end, "National holiday", "Home", true, true, null);
  ...
  public void testPrivateEvent() {
    ...
    SingleEvent event = new SingleEvent("Lunch", start, end, "Personal time", "Cafeteria", false, false, null);
  ...
  public void testToStringFormat() {
    ...
    SingleEvent event = new SingleEvent("Standup", start, end, "Daily meeting", "Office", true, false, null);
